...
df = pd.read_csv("/Users/alicankizal/Desktop/Miuul Summer Bootcamp/2. hafta/persona.csv")
df.head()
df.info()
df.describe().T
...
agg_df["customers_level_based"] = [cols[0].upper() + "_" + cols[1].upper() + "_" + cols[2].upper() + "_" + cols[3].upper() for cols in agg_df[col_list].values]
...
#agg_df[agg_df["customers_level_based"] == new_user][["SEGMENT", "PRICE"]]


# 35 yaşında IOS kullanan bir Fransız kadını hangi segmente ve ortalama ne kadar gelir kazandırması beklenir?
new_user2 = "FRA_IOS_FEMALE_31_40"
agg_df[agg_df["customers_level_based"] == new_user2]
 ##son 3 görevi güncelleyebilirim